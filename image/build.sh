...
docker build -t "docker.io/hk1232/operator-hello-world:latest" .
docker tag docker.io/hk1232/operator-hello-world:latest docker.io/hk1232/operator-hello-world:0.${version}
docker push docker.io/hk1232/operator-hello-world:0.${version}
